...
Create a new repository for today called `chocolate-pizza`. Be sure, before starting to code, to think about a strategy for approaching this project. Before writing code, think about a practical order in which to do the work:
...
4. Add comments to your Canvas submission with answers to the following questions.
  - What did you learn from this lab? What were you able to teach to others?
